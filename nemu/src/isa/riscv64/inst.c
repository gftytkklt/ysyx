...
// those patten can use for simplicity if needed
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(dest) = SEXT(BITS(SEXT(BITS(src1,31,0),32) / SEXT(BITS(src2,31,0),32), 31, 0), 32));
  INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divuw  , R, R(dest) = SEXT(BITS(BITS(src1,31,0) / BITS(src2,31,0), 31, 0), 32));
  INSTPAT("0000001 ????? ????? 110 ????? 01110 11", remw   , R, R(dest) = SEXT(BITS(SEXT(BITS(src1,31,0),32) % SEXT(BITS(src2,31,0),32), 31, 0), 32));
