...
Vysyx_22040750::Vysyx_22040750(VerilatedContext* _vcontextp__, const char* _vcname__)
    : vlSymsp{new Vysyx_22040750__Syms(_vcontextp__, _vcname__, this)}
...
Vysyx_22040750::Vysyx_22040750(const char* _vcname__)
    : Vysyx_22040750(nullptr, _vcname__)
{
}
...
QData Vysyx_22040750___024root___change_request(Vysyx_22040750___024root* vlSelf);
#ifdef VL_DEBUG
...
static void _eval_initial_loop(Vysyx_22040750__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            Verilated::debug(1);
            __Vchange = Vysyx_22040750___024root___change_request(&(vlSymsp->TOP));
            Verilated::debug(__Vsaved_debug);
            VL_FATAL_MT("/home/gftyt/ysyx-workbench/npc/vsrc_fullpipline/ysyx_22040750.v", 22, "",
...
void Vysyx_22040750::final() {
    Vysyx_22040750___024root___final(&(vlSymsp->TOP));
}

//============================================================
// Utilities

VerilatedContext* Vysyx_22040750::contextp() const {
...
static void traceInit(void* voidSelf, VerilatedVcd* tracep, uint32_t code) {
    ...
    tracep->scopeEscape(' ');
    Vysyx_22040750___024root__traceInitTop(vlSelf, tracep);
    tracep->scopeEscape('.');
}

void Vysyx_22040750___024root__traceRegister(Vysyx_22040750___024root* vlSelf, VerilatedVcd* tracep);

void Vysyx_22040750::trace(VerilatedVcdC* tfp, int, int) {
    tfp->spTrace()->addInitCb(&traceInit, &(vlSymsp->TOP));
    Vysyx_22040750___024root__traceRegister(&(vlSymsp->TOP), tfp->spTrace());
}
